...
export const hero = {
  ...
  titleEm: '从数据大屏到桌面端',
  titleEnd: '，把想法做成能用的东西。',
  lead: '你好，我是赵雪丽。日常用 Vue 搭中后台和大屏，也做 Electron 桌面工具、小程序和 H5；业余时间在 Cloudflare Workers 上把自己的小需求做成四端同步的产品。',
...
export const works: Work[] = [
  {
    ...
    period: '进行中',
    summary: '我自己的任务提醒助手：周期提醒、重要程度、每日总结和账号记录，Web、Windows 桌面端和 Android 手机端共用一套 Serverless 接口。',
    highlights: [
      'Cloudflare Workers 提供 API，Durable Objects 持久化用户数据，KV 做配置。',
      'React + Vite 的 Web 端托管在 GitHub Pages，Electron 与 Expo 客户端复用同一套接口。',
      'GitHub Actions push 即构建部署；自建 Pages 代理层解决国内访问 API 的可达性问题。',
    ],
    stack: ['React', 'Vite', 'Electron', 'Expo', 'Cloudflare Workers', 'Durable Objects'],
    image: null,
    imageAlt: 'Sherlly Assistant 三端界面截图',
    links: [{ label: '源码', href: 'https://github.com/sherllyzhao' }],
  },
  {
    slug: 'media-publisher',
    kicker: 'Electron 桌面工具 · 独立开发',
    title: '自动发布媒体工具',
    period: '山西资海',
    summary: '给运营同事做的多平台内容自动发布工具，一次填写，把视频和图文分发到抖音、小红书、视频号、百家号、今日头条等 9 个平台。',
    highlights: [
      '基于 Electron 内置 Chromium，按 URL 注入脚本完成表单填写、素材上传和定时发布。',
      '多账号独立 Session 并持久化，重启不掉登录态；主窗口与子窗口双向通信。',
      '解决注入事件 isTrusted 校验、头条表单保存失败等难点，打包 Windows exe 与 macOS dmg。',
    ],
